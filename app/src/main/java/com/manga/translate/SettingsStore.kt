...
class SettingsStore(context: Context) {
    ...
    fun loadLocalVlmModelPrecision(): String {
        return prefs.getString(KEY_LOCAL_VLM_MODEL_PRECISION, DEFAULT_LOCAL_VLM_MODEL_PRECISION)
            ?: DEFAULT_LOCAL_VLM_MODEL_PRECISION
    }

    fun saveLocalVlmModelPrecision(precision: String) {
        prefs.edit() {
            putString(KEY_LOCAL_VLM_MODEL_PRECISION, precision)
        }
    }
